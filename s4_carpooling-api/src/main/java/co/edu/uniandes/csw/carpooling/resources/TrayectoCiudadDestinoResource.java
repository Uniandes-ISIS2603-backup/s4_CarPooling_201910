...
import co.edu.uniandes.csw.carpooling.ejb.TrayectoCiudadDestinoLogic;
...
public class TrayectoCiudadDestinoResource {

    @Inject
    private TrayectoCiudadDestinoLogic trayectoCiudadLogic; // Variable para acceder a la lógica de la aplicación. Es una inyección de dependencias.
