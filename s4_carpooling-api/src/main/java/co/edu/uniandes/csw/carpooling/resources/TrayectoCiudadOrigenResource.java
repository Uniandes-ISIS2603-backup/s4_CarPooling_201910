...
import co.edu.uniandes.csw.carpooling.ejb.TrayectoCiudadOrigenLogic;
...
public class TrayectoCiudadOrigenResource {
    
     @Inject
    private TrayectoCiudadOrigenLogic trayectoCiudadLogic; // Variable para acceder a la lógica de la aplicación. Es una inyección de dependencias.
    ...
    public CiudadDTO createCiudad(@PathParam("trayectoId") Long idTrayecto, CiudadDTO ciudad) throws BusinessLogicException {
        CiudadDTO nuevoReviewDTO = new CiudadDTO(trayectoCiudadLogic.createCiudadOrigen(idTrayecto, ciudad.toEntity()));
